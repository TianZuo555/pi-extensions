...
Forward custom compaction instructions, bound the entire remote request including SSE body reading, and allow recovery after transient route failures. Add checkpoint lifecycle and transport regression tests.
