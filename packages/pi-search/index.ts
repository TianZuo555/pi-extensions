// pi-tian-search — ripgrep/fd-backed search tools for the pi coding agent.
//
...
// regex/literal detection, fuzzy path matching, cursor pagination, and prompt
// guidelines (pi ships its built-in grep/find with none).
//
// Quick try:  pi -e ./packages/pi-search
